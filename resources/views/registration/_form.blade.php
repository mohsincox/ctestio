...
<div class="form-group {{ $errors->has('depot_app_user') ? 'has-error' : ''}}">
    {!! Form::label('depot_app_user', 'Name/Outlet/Mobile Detail', ['class' => 'required col-3 col-sm-3 control-label']) !!}
    <div class="col-xs-9 col-sm-9">
...
<div class="form-group {{ $errors->has('zone') ? 'has-error' : ''}}">
    {!! Form::label('zone', 'Outlet', ['class' => 'required col-3 col-sm-3 control-label']) !!}
    <div class="col-xs-9 col-sm-9">
        ...
        {!! Form::select('zone', ['Dhanmondi Outlet' => 'Dhanmondi Outlet', 'Banani Outlet' => 'Banani Outlet', 'DOHS Mirpur Outlet' => 'DOHS Mirpur Outlet', 'Mirpur 01 Outlet' => 'Mirpur 01 Outlet', 'Basundhara Outlet' => 'Basundhara Outlet', 'Uttara Outlet' => 'Uttara Outlet'], null, ['class' => 'form-control', 'placeholder' => 'Select Outlet']) !!}
        <span class="text-danger">
		    {{ $errors->first('zone') }}
	    </span>
    </div>
