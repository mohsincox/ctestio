        	...
        	<div class="col-md-12">
            	<div class="box box-primary">
                	<div class="box-header">
                    	<h3 class="box-title">Rider Users List</h3> 
                    	<div class="box-tools pull-right">
                    		<a href="{{ url('user-registration/create') }}" class="btn btn-primary btn-flat"> <i class="fa fa-plus"></i> Create Rider User</a>
                    	</div>
                	</div>
                	<div class="box-body">
