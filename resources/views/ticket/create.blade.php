    							...
    							<div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            {!! Form::open(['url' => 'order', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'ticketForm']) !!}
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <h3>Want to Create Order?</h3>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-outline submitBtnTicket">Create Order</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#ticket_type_id").change(function() {
                ...
                var url = '{{ url("/order/get-assigned")}}';
        ...
        $(function() {
            $(document).on('click', '.add-cart-item-create', function(e){
                ...
                var url = '{{ url("/order-cart/add-to-cart")}}'
        ...
        $(function() {
            $(document).on('click', '.delete-cart-item', function(){
                ...
                var url2  = '{{ url("/order-cart/remove-one-item")}}' + "/" + key_id;
