                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							<div class="card-header">
    								<h3 class="text-center"><i class="fa fa-edit"></i> Update Form of <code><b>Order</b></code> </h3>
    							</div>
                                
    							<div class="card-body">
    						  		
                                    {!! Form::model($ticket, ['url' => "order/$ticket->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
                                    
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group {{ $errors->has('ticket_status_id') ? 'has-error' : ''}}">
                                                {!! Form::label('ticket_status_id', 'Order Status', ['class' => 'required col-xs-3 col-sm-3 control-label']) !!}
                                                <div class="col-xs-9 col-sm-9">
                                                    {!! Form::select('ticket_status_id', $ticketStatusList, null, ['class' => 'form-control','placeholder' => 'Select Order Status']) !!}
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a href="{{ url('/order') }}" class="btn btn-default">Cancel</a>
                ...
                <div class="panel panel-primary">
                            <div class="panel-heading text-center"><code>Order ID: <b>{{ $ticket->id }}</b></code> <code>Customer Number: <b>{{ $ticket->phone_number }}</b></code></div>
                                <div class="panel-body">
                                    ...
                                    <h4><code>Order ID: <b><a href="{{ url('/order/' . $ticket->id) }}">{{ $ticket->id }}</a></b></code></h4> 
