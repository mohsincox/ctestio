            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Order Lists </i></h3>
                        <div class="box-tools pull-right">
                            @can('ticket_admin-access')
                    		<a href="{{ url('order/create') }}" class="btn btn-primary btn-flat"> <i class="fa fa-plus"></i> Create Order</a>
                            @endcan
                            @can('agent-access')
                            <a href="{{ url('order/create') }}" class="btn btn-primary btn-flat"> <i class="fa fa-plus"></i> Create Order</a>
                            @endcan
                    ...
                    <div class="box-body">
                        <div class="table-responsive"> 
                            <table id="exampleZZ" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <!-- <th>SL</th> -->
                                        <th>OID</th>
                                ...
                                @foreach($tickets as $ticket)
                                    ...
                                    <tr>
                                        <!-- <td>{{ ++$i }}</td> -->
                                        <td><a class="btn btn-primary btn-xs" href="{{ url('/order/' . $ticket->id) }}">{{ $ticket->id }}</a></td>
                                        ...
                                        <!-- <td>{!! Html::link("order/$ticket->id/edit",' Edit', ['class' => 'fa fa-edit btn btn-primary btn-xs']) !!}</td> -->
