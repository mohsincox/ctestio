                                    ...
                                    <div class="table-responsive">          
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <!-- <tr>
                                                    <td><b>Product Detail</b></td>
                                                    <td colspan="3">{{ $ticket->product_detail }}</td>
                                                </tr> -->
                                                <tr>
                                   ...
                                   <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            @if(isset($ticket->product_detail))
                                                ...
                                                @endif
                                            @endif
                                            <p class="text-center" style="margin-bottom: 0px;">Total Price: <b>{{ $ticket->total_price }}</b></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-footer hidden-print">
                                        ...
                                        <a href="{{ url('/order/'.$ticket->id.'/edit') }}" class="btn btn-success btn-xs btn-block">Update This Order</a>
