        	...
        	<div class="col-md-8 col-sm-offset-2">
            	<div class="box box-success">
                	<div class="box-header with-border">
                    	<h3 class="box-title">Outlet Wise Order Report Form</h3> 
                	</div>
                	<div class="box-body">
                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							<div class="card-header">
    								<h3 class="text-center"><i class="fa fa-chart-bar"></i> <code><b>Outlet Wise Order</b></code> Report Form</h3>
    							</div>
    							<div class="card-body">
                                    ...
                                    <div class="form-group {{ $errors->has('ticket_type_id') ? 'has-error' : ''}}">
	                                    {!! Form::label('ticket_type_id', 'Outlet', ['class' => 'col-3 col-sm-3 control-label required']) !!}
	                                    <div class="col-xs-9 col-sm-9">
	                                       {!! Form::select('ticket_type_id', $ticketTypeList, null, ['class' => 'form-control select2', 'placeholder' => 'Select Outlet', 'required' => 'required']) !!}
	                                        <span class="text-danger">
